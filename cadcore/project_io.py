...
def serialize_feature(f: Feature) -> dict:
    data: Dict[str, Any] = {
        ...
        "pattern_count": int(getattr(f, "pattern_count", 2)),
        "pattern_dx": float(getattr(f, "pattern_dx", 10.0)),
        "pattern_dy": float(getattr(f, "pattern_dy", 0.0)),
        "pattern_dz": float(getattr(f, "pattern_dz", 0.0)),
        "pattern_angle": float(getattr(f, "pattern_angle", 360.0)),
...
def deserialize_feature(data: dict) -> Feature:
    ...
    return Feature(
        ...
        pattern_count=int(data.get("pattern_count", 2)),
        pattern_dx=float(data.get("pattern_dx", 10.0)),
        pattern_dy=float(data.get("pattern_dy", 0.0)),
        pattern_dz=float(data.get("pattern_dz", 0.0)),
        pattern_angle=float(data.get("pattern_angle", 360.0)),
